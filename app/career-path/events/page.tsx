      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 text-center">
            <Button variant="outline" className="border-yellow-600 text-yellow-700 hover:bg-yellow-50 bg-transparent">
                ...
                <Card key={category.id} className="hover:shadow-md transition-shadow">
                  ...
                  <CardFooter>
                    <Button
                      ...
                      asChild
                    >
                      <Link href={`/career-path/events?category=${category.id}`}>Browse Events</Link>
                    </Button>
                  </CardFooter>
                </Card>
              )
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="p-8 lg:p-12">
                  ...
                  <Button size="lg" className="bg-green-600 hover:bg-green-700 text-white" asChild>
                    <Link href={`/career-path/events/${featuredEvent.id}`}>Register Now</Link>
                  </Button>
                </div>
              </div>
            </div>
