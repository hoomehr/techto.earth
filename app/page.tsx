...
import { ArrowRight, BookOpen, Calendar, Users, Code, Sprout, Utensils, Tractor } from "lucide-react"
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-gray-600 italic mb-4">
                      "After 12 years as a software engineer, I now run a small organic farm. TechTo.Earth's courses
        ...
        <div className="container text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-yellow-400 text-yellow-50 hover:bg-green-500 hover:text-white"
            >
